...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  {
    key: "apps-culturesoptions",
    label: "Culture Options",
    isTitle: false,
    icon: "briefcase",
    url: "/apps/culturesoptions",
  },
  {
    key: "apps-antibiotics",
    label: "Antibiotics",
    isTitle: false,
    icon: "shield",
    ...
    children: [
      {
        ...
        label: "Tests",
        icon: "circle",
        url: "/app/price-list/tests",
        parentKey: "app-pricelist",
      },
      {
        key: "pricelist-culture",
        label: "Cultures",
        icon: "circle",
        url: "/app/price-list/cultures",
        parentKey: "app-pricelist",
      },
    ],
  },
